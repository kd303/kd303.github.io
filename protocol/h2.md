...
## [OpenAPI]([https://grpc.io/](https://www.openapis.org/) ##
...
- Refer to this [blog from google](https://cloud.google.com/blog/products/api-management/understanding-grpc-openapi-and-rest-and-when-to-use-them) -  (obviously with pinch of salt), on some key issues in design of OpenAPI based services.
